...
Install all required libraries (many can be installed using the npm install from frontend folder)
1. Run analysis.py on a compiler
2. In a terminal, change directory to the frontend folder and do command npm run dev
3. Open the site in the localhost

Contributors:
Andrew Hoberer, Serhan Doganay, Anthony Zhou, and Jeff Lai

Devpost for our project:
https://devpost.com/software/team-registration-2qcu3x?ref_content=my-projects-tab&ref_feature=my_projects
...
Link to api:
https://hackutd2025.eog.systems/swagger/index.html
